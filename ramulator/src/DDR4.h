...
public:
    ...
    /* Prereq */
    function<Command(DRAM<DDR4>*, Command cmd, int,  ulong)> prereq[int(Level::MAX)][int(Command::MAX)];

    // SAUGATA: added function object container for row hit status
    /* Row hit */
    function<bool(DRAM<DDR4>*, Command cmd, int, ulong)> rowhit[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<DDR4>*, Command cmd, int)> rowopen[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<DDR4>*, Command cmd, int, ulong)> sectormiss[int(Level::MAX)][int(Command::MAX)];
    ...
    /* Lambda */
    function<void(DRAM<DDR4>*, int, ulong)> lambda[int(Level::MAX)][int(Command::MAX)];
